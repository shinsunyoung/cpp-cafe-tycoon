...
int customer[] = { 5, 10, 15, 20 }; // 고정된 손님의 최소 수

int cout_length = 43; // 이건 오류나서 걍 넣음 신경 X


string today_menu = "";
int today_menu_price = 0;

int event_buff = 1; // 1.5배 이벤트를 위해!
...
void sell_result() {
	...
	cout << "■                                                                        ■" << endl;
	cout << "■                                                                        ■" << endl;
	cout << "■                       온 손님의 수 : " << customer_num << " 명                             ■" << endl;
	cout << "■                                                                        ■" << endl;
...
void play() { // 중간 제출 용으로 한 판의 분량만 만듦!
	...
	while (true) {
		...
		rank_im = 1000 - (money / 300); // 30만원 이상이면 1위
		...
		cout << "■                                                                        ■" << endl;
		cout << "■                                                                        ■" << endl;
		cout << "■"; cout.width(63); cout.fill(' ');  cout << " 우리 카페는 전국 단위 "; YELLOW cout << rank_im;  ORIGINAL cout << " 위! ■" << endl;
		cout << "■                                                                        ■" << endl;
